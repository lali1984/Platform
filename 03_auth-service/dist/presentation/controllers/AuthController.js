...
class AuthController {
    constructor(registerUserUseCase, loginUserUseCase, userResponseMapper, tokenService, userRepository) {
        ...
        try {
            ...
            if (result.user && result.tokens) {
                try {
                    ...
                    await this.tokenService.saveRefreshToken(result.user.id, result.tokens.refreshToken);
                }
                catch (error) {
