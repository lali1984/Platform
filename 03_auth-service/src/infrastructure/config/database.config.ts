...
import { RoleEntity } from '../persistence/entities/Role.entity';           // ДОБАВИТЬ
import { PermissionEntity } from '../persistence/entities/Permission.entity'; // ДОБАВИТЬ
import { UserRoleEntity } from '../persistence/entities/UserRole.entity';     // ДОБАВИТЬ
