...
describe('User Entity', () => {
    ...
    describe('business logic', () => {
        ...
        it('should verify user', () => {
            ...
            expect(new Date(user.updatedAt).getTime()).toBeGreaterThan(new Date(oldUpdatedAt).getTime());
        });
        it('should deactivate user', () => {
            ...
            if (user.deletedAt && oldDeletedAt) {
                expect(new Date(user.deletedAt).getTime()).toBeGreaterThan(new Date(oldDeletedAt).getTime());
            }
        });
