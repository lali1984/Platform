...
let OutboxEventPublisher = OutboxEventPublisher_1 = class OutboxEventPublisher {
    ...
    _getRepository(queryRunner) {
        ...
        return 'getRepository' in queryRunner
            ? queryRunner.getRepository(outbox_event_entity_1.OutboxEventEntity)
            : queryRunner.manager.getRepository(outbox_event_entity_1.OutboxEventEntity);
    }
...
//# sourceMappingURL=outbox-event-publisher.service.js.map