...
const kafka_producer_service_1 = require("../messaging/kafka-producer.service");
    ...
    (0, common_1.Module)({
        providers: [
            ...
            kafka_bootstrap_service_1.KafkaBootstrapService,
            {
                ...
                useExisting: kafka_producer_service_1.KafkaProducerService,
            },
            {
                provide: 'EventConsumer',
                useExisting: kafka_consumer_service_1.KafkaConsumerService,
            },
        ],
        exports: [
            kafka_producer_service_1.KafkaProducerService,
