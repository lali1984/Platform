import { databaseConfig, ServiceDatabaseConfig } from '../infrastructure/db/config';
import { createOutboxReaderRepository, OutboxReaderRepository } from '../infrastructure/db/outbox-reader';
import { createKafkaProducer, KafkaProducerService, EventMessage } from '../infrastructure/messaging/kafka-producer';
import { getEventRelayMetricsService } from '../infrastructure/metrics/metrics-service';
import { createCircuitBreaker, CircuitBreaker } from '../infrastructure/messaging/circuit-breaker';
